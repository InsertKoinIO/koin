...
## [Latest Version](https://insert-koin.io/docs/upgrade/whats-new)

Please follow the [instructions](https://insert-koin.io/docs/setup/koin) to set up Koin in your project.
Artifacts are available on [Maven Central](https://search.maven.org/search?q=io.insert-koin).
