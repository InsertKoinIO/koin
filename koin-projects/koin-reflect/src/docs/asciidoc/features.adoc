...
[IMPORTANT]
====
Keep in mind that `build()` function is not just magic, it has also a very small cost (the time to take yoru constructor and inject each argument). If you care about performances,
