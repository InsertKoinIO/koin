 ...
 */
fun <T> KoinComponent.get(modelClass: Class<T>, module: String? = null, parameters: Parameters): T =
 ...
 * Resolve an instance by its canonical name
 */
fun <T> KoinComponent.getByName(name: String, module: String? = null, parameters: Parameters): T =
